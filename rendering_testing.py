...
parser.add_argument('-o', dest='output_file', help='File to store the output', action='store', required=True)
parser.add_argument('-e', dest='error_file', help='File to store the wrong renderings', action='store', required=True)
